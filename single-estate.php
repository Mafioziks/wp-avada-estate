	...
	<div id="content" style="<?php echo $content_css; ?>">
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
			...
			<div class="entry-data">
				<span>
					<span class="entry-value"><?php echo get_post_custom_values('price', $post->ID)[0] . ' €';  ?></span>
					<span class="entry-description"><?= __('Price: ', 'estate') ?></span>
				</span>
				<span>
					<span class="entry-value"><?php echo get_post_custom_values('floor', $post->ID)[0];  ?></span>
					<span class="entry-description"><?= __('Floor: ', 'estate') ?></span>
				</span>
				<span>
					<span class="entry-value"><?php echo get_post_custom_values('rooms', $post->ID)[0];  ?></span>
					<span class="entry-description"><?= __('Rooms: ', 'estate') ?></span>
				</span>
				<span>
					<span class="entry-value"><?php echo get_post_custom_values('area', $post->ID)[0];  ?></span>
					<span class="entry-description"><?= __('Area: ', 'estate') ?></span>
				</span>
				<span>
					<span class="entry-value"><?= get_the_terms($post, 'region')[0]->name ?></span>
					<span class="entry-description"><?= __('City: ', 'estate') ?></span>
				</span>
				<?php if (get_the_terms($post, 'region')[0]->slug == 'riga'): ?>
				<span>
					<span class="entry-value"><?= get_the_terms($post, 'residental')[0]->name  ?></span>
					<span class="entry-description"><?= __('Residental: ', 'estate') ?></span>
				</span>
				<?php endif; ?>
				<span>
					<span class="entry-value"><?php echo get_post_custom_values('street', $post->ID)[0];  ?></span>
					<span class="entry-description"><?= __('Street: ', 'estate') ?></span>
				</span>
				<span>
					<span class="entry-value"><?= get_the_terms($post, 'action')[0]->name ?></span>
					<span class="entry-description"><?= __('Action: ', 'estate') ?></span>
				</span>
			</div>
			...
			<div class="share-box">
				<h4><?php echo __('Share this on: ', 'Avada'); ?></h4>
